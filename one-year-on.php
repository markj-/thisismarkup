    ...
    <div class="container sub">
        ...
        <div class="main" role="main">
            <div class="article">
                ...
                <p>Whilst we're not quite there with Unit Testing, something that we are there with is Functional Testing. I love Functional Testing and would encourage anyone building applications with JavaScript to take a look at <a href="http://casperjs.org/">CasperJS</a> and see the value it could bring to your workflow. I find functional testing a lot simpler than Unit Testing due to it being obvious what to test and due to the tests taking very little time to write it shouldn't be difficult to convince other team members to write them as well.</p>
